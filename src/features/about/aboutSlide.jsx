  ...
  return (
    <div className={active ? 'flex flex-col max-w-5xl mx-auto transition-all' : 'opacity-0 fixed w-0 top-0 h-0 z-0'}>
      ...
      <div className={`${active
        ? 'transition-all duration-700 left-0 h-screen fixed w-0 z-0 bg-white top-0 pointer-events-none'
        : 'top-0 h-screen w-screen bg-white fixed z-10 pointer-events-none'}`} />
