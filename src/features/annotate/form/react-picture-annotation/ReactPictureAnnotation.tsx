        ...
        <div className="rp-form my-10">
          ...
          <div className="flex justify-center my-12 gap-4"> {/* Added gap-4 for spacing */}
            ...
            {this.props.currentAnnotationCount > 1 && (
              <button
                className="transition-all duration-500 ease-in-out font-semibold py-2 px-6 rounded border hover:-translate-y-0.5 hover:shadow-md text-[#1d1d1d] hover:border-[#1d1d1d]"
                type="button"
